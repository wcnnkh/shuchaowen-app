...
<link rel="stylesheet" href="${_contextPath}/admin/css/base.css">
<script src="${_contextPath}/admin/lib/jquery/jquery.min.js"></script>
<script
	src="${_contextPath}/admin/lib/jquery/jquery.cookie.min.js"></script>
<script src="${_contextPath}/admin/lib/lightbox/lightbox.min.js"></script>
...
<script type="text/javascript"
	src="${_contextPath}/admin/lib/ztree/js/jquery.ztree.core.js"></script>
<script type="text/javascript"
	src="${_contextPath}/admin/lib/ztree/js/jquery.ztree.excheck.js"></script>
<!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
<!--[if lt IE 9]>
